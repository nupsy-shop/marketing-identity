...
const PLATFORM_DEFINITIONS = [
  ...
  { key: 'meta', names: ['meta', 'facebook', 'meta business manager / facebook ads', 'facebook ads'], legacySlug: 'meta-business-manager' },
  { key: 'ga4', names: ['ga4', 'google analytics / ga4', 'google analytics'], legacySlug: 'google-analytics' },
  ...
  { key: 'tiktok', names: ['tiktok', 'tiktok ads'], legacySlug: 'tiktok-ads' },
  { key: 'snapchat', names: ['snapchat', 'snapchat ads'], legacySlug: 'snapchat' },
  { key: 'linkedin', names: ['linkedin', 'linkedin ads'], legacySlug: 'linkedin-ads' },
  { key: 'pinterest', names: ['pinterest', 'pinterest ads'], legacySlug: 'pinterest-ads' },
  { key: 'hubspot', names: ['hubspot'], legacySlug: 'hubspot' },
  { key: 'salesforce', names: ['salesforce'], legacySlug: 'salesforce' },
  { key: 'gtm', names: ['google tag manager', 'gtm'], legacySlug: 'google-tag-manager' },
