...
export const platformAccessInstructions = [
  {
    platform: 'Google Ads',
...
function normalizeKey(platform, pattern) {
...
export function parseDataToCollect(dataToCollect) {
  const fields = [];
...
function matchPlatformName(searchName) {
...
function matchAccessPattern(searchPattern, platform) {
...
export function getAccessInstruction(platformName, accessPattern) {
...
export function getInstructionsForPlatform(platformName) {
  const matchedPlatform = matchPlatformName(platformName);
...
export function getFieldsForAccessItem(platformName, accessPattern) {
...
export function getClientInstructions(platformName, accessPattern) {
  const instruction = getAccessInstruction(platformName, accessPattern);
  if (!instruction) {
...
export function requiresAssetSelection(platformName, accessPattern) {
  const instruction = getAccessInstruction(platformName, accessPattern);
