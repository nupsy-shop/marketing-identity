...
class GTMPlugin implements PlatformPlugin, AdPlatformPlugin {
  readonly name = 'gtm';
  ...
  buildClientInstructions(context: InstructionContext): InstructionStep[] {
    ...
    return [{ step: 1, title: 'Open GTM', description: 'Go to tagmanager.google.com', link: { url: 'https://tagmanager.google.com', label: 'Open GTM' } }, { step: 2, title: 'Add User', description: `Add user with "${roleTemplate}" permission.` }];
  }
